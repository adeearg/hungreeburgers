...
import com.adee.hungreeburgers.beans.AbstractFacade;
...
/**
 * Represents an abstract shell of to be used as JSF Controller to be used in AJAX-enabled applications. No outcomes will be generated from its methods since
 * handling is designed to be done inside one page.
 * @param <T>
 */
